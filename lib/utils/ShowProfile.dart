...
class ProfileState extends State<ShowProfile> {
  ...
  getRepo() async {
    var res = await http.get(
        getURL() + "repos", headers: {"Accept": "application/json"});
  ...
  getStarred() async {
    var res = await http.get(
        getURL() + "starred", headers: {"Accept": "application/json"});
    ResBody = json.decode(res.body);
    setState(() {
      for (var data in ResBody) {
        _starred.add(
    ...
    if (repo_loading) {
      ...
      return new Center(
        child: new Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              new Text("$user have No Repo", style: Theme
                  .of(context)
                  .textTheme
                  .display1)
            ]
    ...
    if (gist_loading) {
      ...
      return new Center(
        child: new Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              new Text("$user have No Gists", style: Theme
                  .of(context)
                  .textTheme
                  .display1)
            ]
    ...
    if (star_loading) {
      ...
      return new Center(
        child: new Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              new Text("$user haven't starred any Repos", style: Theme
                  .of(context)
                  .textTheme
                  .display1)
            ]
    ...
    if (following_loading) {
      ...
      return new Center(
        child: new Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              new Text("$user is not following to anyone", style: Theme
                  .of(context)
                  .textTheme
                  .display1)
            ]
    ...
    if (followers_loading) {
      ...
      return new Center(
        child: new Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              new Text("$user have no Follower", style: Theme
                  .of(context)
                  .textTheme
                  .display1)
            ]
